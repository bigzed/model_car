...
\begin{document}
  \section{Aufabe 2}
    \begin{center}
      \includegraphics[scale=0.6]{pictures/gray_scale.png}
    \end{center}
  \section{Aufabe 3}
	\begin{center}
     \includegraphics[scale=0.6]{pictures/black_scale.png}
    \end{center}
  \section{Aufabe 4, 5, 6}
    \subsection{Terminal}
    \lstinputlisting{text/camera_calibration.final}
    \subsection{Source}
      \lstinputlisting[language=Python]{../catkin_ws/src/assignment4_camera_calibration/src/camera_calibration.py}
\end{document}
