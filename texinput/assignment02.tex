...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{Steve Dierker, Semjon Kerner, Arthur Jeske}
...
\begin{document}
  \section{Aufabe 1}
    ...
    \end{center}
  \section{Aufgabe 2}
  Den Quellcode finden sie hier \url{https://github.com/bigzed/model_car/blob/version-4.0/catkin_ws/src/assignment1_publisher_subscriber/src/publisher_subscriber.py}
